...
const AddMemory = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!file) return alert('Please add a photo first!');
        setLoading(true);
        ...
        <div className={styles.pageWrapper}>
            ...
            <div className={styles.card} ref={cardRef}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {!preview ? (
                        /*
                         * THE FIX: the <label> wraps the entire visible box (.dropzoneBox),
                         * so clicking ANYWHERE on the box triggers the hidden file input.
                         * The hidden <input> is a sibling inside the label.
                         */
